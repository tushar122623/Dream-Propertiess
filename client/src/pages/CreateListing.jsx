    ...
    <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
        <div className='flex flex-col gap-4 flex-1'>
            ...
            <input type="text" placeholder='Address' className='border p-3 rounded-lg'
               ...
               <div className='flex items-center gap-2'>
                <input type='number' id='bedrooms' min='1' max='10' required className='p-3
                  border border-gray-300 rounded-lg' onChange={handleChange}
               ...
               <div className='flex items-center gap-2'>
                <input type='number' id='regularPrice' min='6000' max='50000000' required className='p-3
                  border border-gray-300 rounded-lg' onChange={handleChange}
                ...
                {formData.offer && (
               <div className='flex items-center gap-2'>
                <input type='number' id='discountPrice' min='0' max='50000000' required className='p-3
                  border border-gray-300 rounded-lg' onChange={handleChange}
        ...
        <div className='flex flex-col flex-1 gap-4'>
            ...
            <div className='flex gap-4'>
                ...
                <button type="button" 
                        disabled={uploading}
                        onClick={handleImageSubmit} className='p-3 text-green-700 border border-green-700 rounded uppercase
